...
for variable in FRUTO_API_IMAGE FRUTO_CONSOLE_IMAGE FRUTO_OPERATOR_IMAGE FRUTO_AGENT_IMAGE FRUTO_TESTKIT_IMAGE; do
  reference="${!variable:-}"
...
for reference in "$FRUTO_API_IMAGE" "$FRUTO_CONSOLE_IMAGE" "$FRUTO_OPERATOR_IMAGE" "$FRUTO_AGENT_IMAGE" "$FRUTO_TESTKIT_IMAGE"; do
