...
for secret in fruto-control-plane-postgres fruto-control-plane-db fruto-control-plane-bootstrap registry-pull fruto-parameter-fingerprint molejo-observability-reader; do
