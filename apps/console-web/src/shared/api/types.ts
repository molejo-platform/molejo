...
export type HTTPAssociation = components["schemas"]["HTTPAssociation"];
export type PublicationOption = components["schemas"]["PublicationOption"];
export type PublicationObservation = components["schemas"]["PublicationObservation"];
