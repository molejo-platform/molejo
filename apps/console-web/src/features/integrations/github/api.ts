...
export const listGitHubInstallations = (workspaceId: string) =>
  request<{ items: GitHubInstallation[] }>(githubBase(workspaceId));
...
export const listGitHubRepositories = (workspaceId: string, installationId: string) =>
