...
export function RuntimeConfigurationFields({ value, onChange, variables, onVariablesChange, variablesError, availableParameters = [], disabled = false }: RuntimeConfigurationFieldsProps) {
