...
export function WorkspaceSettingsPage() {
  ...
  const update = useMutation({ mutationFn: (nextName: string) => updateWorkspace(workspace!, { name: nextName }), onSuccess: () => queryClient.invalidateQueries({ queryKey: workspaceQueryKey }) });
