...
describe("workspace access relations", () => {
  it("creates and revokes an explicit group relation from accessible controls", async () => {
    mocks.listAccessGrants.mockResolvedValue({
      items: [
        {
          id: "agr-aaaaaaaaaaaaaaaaaaaa",
          subjectType: "Group",
          subjectId: "grp-aaaaaaaaaaaaaaaaaaaa",
          subjectName: "Deployers",
          resourceType: "Workspace",
          resourceId: "ws-aaaaaaaaaaaaaaaaaaaa",
          relation: "Viewer",
    ...
    mocks.getEffectiveCapabilities.mockResolvedValue({ manageGroups: true });
    ...
    await waitFor(() =>
      expect(mocks.createAccessGrant).toHaveBeenCalledWith("ws-aaaaaaaaaaaaaaaaaaaa", {
        subjectType: "Group",
        subjectId: "grp-aaaaaaaaaaaaaaaaaaaa",
        resourceType: "Workspace",
        resourceId: "ws-aaaaaaaaaaaaaaaaaaaa",
    ...
    await waitFor(() =>
      expect(mocks.deleteAccessGrant).toHaveBeenCalledWith("ws-aaaaaaaaaaaaaaaaaaaa", "agr-aaaaaaaaaaaaaaaaaaaa"),
    );
  });
});
