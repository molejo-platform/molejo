...
export const runtimeConfigurationKeys = {
  storageProfiles: (workspaceId: string, clusterId: string) =>
    ["workspaces", workspaceId, "clusters", clusterId, "storage-profiles"] as const,
...
export const runtimeConfigurationQueries = {
  storageProfiles: (workspaceId: string, clusterId: string) =>
    queryOptions({
      queryKey: runtimeConfigurationKeys.storageProfiles(workspaceId, clusterId),
      queryFn: ({ signal }) => listStorageProfiles(workspaceId, clusterId, signal),
