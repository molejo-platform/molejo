...
import type { App, AppEnvironment, Environment, HierarchyInput, Project } from "../../shared/api/types";
...
export const listEnvironmentApps = (workspaceId: string, projectId: string, environmentId: string) => request<ResourceList<AppEnvironment>>(`${environmentBase(workspaceId, projectId)}/${encodeURIComponent(environmentId)}/apps`);
