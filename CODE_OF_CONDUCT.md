...
[Português (Brasil)](docs/pt-BR/CODE_OF_CONDUCT.md) |
[Español (Argentina)](docs/es-AR/CODE_OF_CONDUCT.md)
...
- Focus disagreement on ideas and evidence, not people.
- Take responsibility for mistakes and their impact.
...
- Trolling, sustained disruption, or deliberately inflammatory conduct.
- Publishing another person's private information without permission.
- Any conduct that would be inappropriate in a professional community.

## Scope

This policy applies in project spaces and when a person officially represents the
...
confidentially and impartially as reasonably possible.
