...
func TestBuildKitSystemPushesAnImmutableImage(t *testing.T) {
	network := strings.TrimSpace(os.Getenv("MOLEJO_TEST_BUILDKIT_NETWORK"))
	clientImage := strings.TrimSpace(os.Getenv("MOLEJO_TEST_BUILDKIT_CLIENT_IMAGE"))
	registryURL := strings.TrimSpace(os.Getenv("MOLEJO_TEST_REGISTRY_URL"))
