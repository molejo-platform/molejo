...
func TestGatewayCertificateFailureRevokesPublicReadinessWithoutAppChange(t *testing.T) {
	ctx := context.Background()
	systemNamespace := &corev1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "fruto-system"}}
	...
	gateway := &gatewayv1.Gateway{
		ObjectMeta: metav1.ObjectMeta{Name: "fruto", Namespace: systemNamespace.Name},
		...
		Status: gatewayv1.HTTPRouteStatus{RouteStatus: gatewayv1.RouteStatus{
			Parents: []gatewayv1.RouteParentStatus{{
				ParentRef: gatewayv1.ParentReference{
					Name: "fruto", Namespace: &gatewayNamespace, SectionName: &httpsSection,
				},
				ControllerName: "fruto.test/gateway-controller",
