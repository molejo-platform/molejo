...
const appVolumeOwnerAnnotation = "platform.fruto.calouro.tech/app-volume-owner"
...
// +kubebuilder:rbac:groups=platform.fruto.calouro.tech,resources=appvolumes,verbs=get;list;watch
// +kubebuilder:rbac:groups=platform.fruto.calouro.tech,resources=appvolumes/status,verbs=get;update;patch
