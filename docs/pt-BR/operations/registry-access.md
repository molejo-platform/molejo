...
molejoctl cluster registry verify --kube-context meu-cluster --file registry-setup.yaml
molejoctl cluster registry smoke --kube-context meu-cluster --file registry-setup.yaml
```
