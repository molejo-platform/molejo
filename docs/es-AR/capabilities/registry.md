...
molejoctl capability registry verify --kube-context mi-cluster --file registry-setup.yaml
molejoctl capability registry smoke --kube-context mi-cluster --file registry-setup.yaml
```
