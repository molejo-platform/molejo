...
[English](../../SECURITY.md) | [Português (Brasil)](../pt-BR/SECURITY.md)
...
- el componente y la revisión afectados;
- pasos para reproducir el problema o una prueba de concepto;
- el impacto esperado;
...
preparar una corrección antes de divulgar públicamente la vulnerabilidad. El
reconocimiento será coordinado con quien hizo el informe cuando corresponda y lo
desee.
