...
molejoctl capability registry verify --kube-context my-cluster --file registry-setup.yaml
molejoctl capability registry smoke --kube-context my-cluster --file registry-setup.yaml
```
